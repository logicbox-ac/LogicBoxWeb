            ...
            blocks: [
                {
                    ...
                    text: formatMessage({
                        id: 'speech2scratch.blocks.startRecognition',
                        default: 'start speech recognition',
                        description: 'Command block text for starting speech recognition'
                    })
                },
                {
                    opcode: 'getSpeech',
                    ...
                    text: formatMessage({
                        id: 'speech2scratch.blocks.getSpeech',
                        default: 'speech',
                        description: 'Reporter block text for the latest speech transcript'
                    })
                }
            ],
            menus: {
